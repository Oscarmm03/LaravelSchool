            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-6 text-gray-500">
                        <form action="{{ route('teacher.games.storeGameCourseAssign', ['id' => $game->id]) }}" method="POST">
                            @csrf
                            <div class="mb-4">
                                <label for="course_id" class="sr-only">Curso</label>
                                <select name="course_id" id="course_id" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('course_id') border-red-500 @enderror">
